...
| Directory                 | Purpose                                                                                         |
| :------------------------ | :---------------------------------------------------------------------------------------------- |
| `src/Context/`            | Contains global state providers (e.g., Auth).                                                   |
| `src/Pages/`              | Top-level route components. Each folder (e.g., `Home/`, `LogIn/`) handles a specific page view. |
| `src/Components/`         | Reusable UI building blocks.                                                                    |
| `src/Components/Card/`    | The movie card used in grids. Handles hover effects and props display.                          |
| `src/Components/Loading/` | A centralized loading spinner component for consistent UX.                                      |
| `src/Components/Navbar/`  | Global navigation bar.                                                                          |
